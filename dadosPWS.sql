...
(default, 'João', 'Lucas', '938472618', '2201118@my.ipleiria.pt', 'Rua do Castelo, nr 13', 'lucas', '1234', 'administrador'),
(default, 'Francisco', 'Matias', '987654321', '2201106@my.ipleiria.pt', 'Rua do lameirao, nr 24', 'matias', '1234', 'administrador'),
(default, 'Guilherme', 'Carolino', '918765412', '2202410@my.ipleiria.pt', 'Rua do Arco, nr 2', 'gui', '1234', 'administrador'),
(default, 'Marco', 'Marques', '912348298', 'mmques@hotmail.com', 'Rua da Luz, nr 69', 'marquez', '1234', 'gestor'),
(default, 'Miguel', 'Pombo', '954334534' 'mpombo@gmail.com', 'Largo de Alvalade, nr 85', 'miguel', '1234', 'operador'),
(default, 'Bruno', 'Honório', '918762484', 'bloperson@outlook.com', 'Rua da Marmelada, nr 90', 'bruno', '1234', 'passageiro'),
(default, 'Paulo', 'Gonzo', '968435623', 'paulinho@gmail.com', 'Avenida dos Lagartos, nr 99', 'paulo', '1234', 'passageiro'),
(default, 'Tiago', 'Horta', '923414146', 'tighorta@hotmail.com', 'Rua de Magalhães, nr 43', 'tiago', '1234', 'passageiro');
